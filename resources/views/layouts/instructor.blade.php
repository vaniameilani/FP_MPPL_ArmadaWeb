...
<html lang="en">
    ...
    <body class="w-100 h-100 p-3 mx-auto flex-column" style="background-color: #f5efef;">
        <div class="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <ul class="navbar-nav">
                            ...
                            <a class="nav-link" href="{{ url('/instructor') }}">Dashboard</a>
                        </ul>
                    </div>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <div class="dropdown-divider"></div>
                                ...
                                <!-- <a class="dropdown-item" href=""><ion-icon name="happy"></ion-icon> Profile</a> -->
        ...
        <footer class="mt-5 text-black text-center container">

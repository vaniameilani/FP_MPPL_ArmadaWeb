<html lang="en">
  ...
  <body>
    <div class="container">
        <div class="row">
            <div class="col-5">
            <h1 class="mt-5">Tambah Instruktur</h1>

                <div class="card-body">
                    <form method="POST" action="{{ route('add.instructor') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            <label for="no_telp" class="col-md-4 col-form-label text-md-right">{{ __('No. HP') }}</label>
